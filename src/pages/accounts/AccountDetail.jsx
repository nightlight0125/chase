...
import { Layout, Row, Col, Button, Dropdown, Card, Badge, Table, Select, Space, Modal } from 'antd'
import {
  RightOutlined,
  DownOutlined,
  LeftOutlined,
...
const AccountDetail = () => {
  ...
  const transactions = [
    {
      key: '1',
      date: 'Nov 03, 2025',
      description: 'ONLINE DOMESTIC WIRE TRANSFER VIA: EW BK SMRINO/322070381 A/C: ALPHAWAVE TRADING GLOBAL INC NEW YORK NY 10013 US REF: BUSINESS EXPENSES IMAD: 1103MMQFMP2K014093 TRN: 3505425307ES 11/03',
    ...
    },
    {
      key: '2',
      date: 'Oct 28, 2025',
      description: 'ONLINE DOMESTIC WIRE TRANSFER VIA: EW BK SMRINO/322070381 A/C: ALPHAWAVE TRADING GLOBAL INC NEW YORK NY 10013 US REF: PURCHASE MATERIAL SAMPLES IMAD: 1028MMQFMP2M006639 TRN: 3156715301ES 10/28',
      type: 'Outgoing wire transfer',
      amount: -75.00,
      balance: 140.00,
    },
    {
      key: '3',
      date: 'Oct 16, 2025',
      description: 'ONLINE DOMESTIC WIRE TRANSFER VIA: EW BK SMRINO/322070381 A/C: ALPHAWAVE TRADING GLOBAL INC NEW YORK NY 10013 US REF: BUSINESS EXPENSES IMAD: 1016MMQFMP2N027603 TRN: 3540805289ES 10/16',
      type: 'Outgoing wire transfer',
      amount: -75.00,
      balance: 215.00,
    },
    {
      key: '4',
      date: 'Oct 15, 2025',
      description: 'ONLINE INTERNATIONAL WIRE TRANSFER A/C: FOREIGN CUR BUS ACCT BK 1 COLUMBUS NEWARK DE 197132107 US ORG: 00000002905306189 AVESTRO GLOBAL INC BEN:/AE810860000009694073852 CONVIA FZE REF: PAYMENT FOR BUSINESS EXPENSES/OCMT/AED391,90/EXCH/3.5627/CNTR/ 587 94956/TRN: 6754100288RE 10/15',
      type: 'Outgoing wire transfer',
      amount: -110.00,
      balance: 290.00,
    },
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (text, record) => (
        record.isLink ? (
          <a href="#" className="transaction-link">{text}</a>
        ) : (
          <span>{text}</span>
        )
      ),
        ...
        <div className="account-detail-inner">
          <div className="account-detail-inner-top">
            <div className="account-detail-inner-top-content">
              ...
              <div className="balance-section-flex">
                ...
                <div className="balance-item-flex">
                  <div className="balance-amount-medium balance-amount-medium-credit">$00.00</div>
                  <div className="balance-label">Available credit</div>
                </div>
                <div className="balance-item-flex">
                  <div className="balance-amount-medium balance-amount-medium-credit">$85.00</div>
                ...
                >
                  <img src={infoIcon} alt="info" className="balance-info-icon" />
          ...
          <div className="promo-offers-wrapper">
            <Row gutter={24} className="promo-offers-row">
              <Col xs={24} lg={12}>
                <Card className="promo-card-detail">
                  <div className="promo-content-detail">
                    <h2 className="promo-title-detail">Sapphire Reserve for Business™ Earn 200,000 bonus points</h2>
                    <div className="promo-details-detail">
                      Receive over $2,500 in annual value. Plus, earn 8x points on Chase Travels, get complimentary access to the Chase Sapphire Lounge® by The Club network and Priority Pass™ Select, and more.
                    </div>
              ...
              <Col xs={24} lg={12}>
                <Card className="chase-offers-card">
                  <div className="card-header">
                    <div>
                      <h3 className="chase-offers-title">Chase Offers</h3>
                      <p className="chase-offers-subtitle">Add deals, shop and get cash back</p>
                    </div>
                  ...
                  <div className="offers-carousel">
                    <img src={leftArrowIcon} alt="left" className="carousel-arrow-left" />
                    <div className="offers-carousel-content">
                      <div className="offer-card">
                        <div className="offer-card-left">
                          <div className="offer-icon-placeholder"></div>
                        ...
                        <div className="offer-card-right">
                          ...
                          <img src={plusIcon} alt="plus" className="offer-add-button" />
                        </div>
                      </div>
                      <div className="offer-card">
                        <div className="offer-card-left">
                    ...
                    <img src={rightArrowIcon} alt="right" className="carousel-arrow-right" />
                  </div>
                </Card>
              </Col>
            </Row>
            ...
            <div className="transactions-section">
              ...
              <div className="transactions-footer">
                <p className="footer-text">
                  If you have other transactions that aren't shown in your account activity, review your{' '}
                  <a href="#" className="footer-link">monthly statements</a>.
                </p>
                <p className="footer-text">You've reached the end of your account activity.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="routing-modal-content">
          <div className="routing-info-row">
            <div className="routing-info-item">
              <span className="routing-label">Account number <span className="routing-value">2905306189</span></span>

              <div className="routing-value-wrapper">
                <PrinterOutlined
                  className="routing-print-icon"
          ...
          <div className="routing-info-row">
            <div className="routing-info-item">
              <span className="routing-label">Routing number <span className="routing-value">322271627</span></span>

            </div>
          </div>
          <div className="routing-note">
            This routing number can only be used for direct deposits and ACH transactions.
            For wire transfers, please use routing number 021000021.
          </div>
        </div>
      </Modal>
    </Layout>

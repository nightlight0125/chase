...
const AppHeader = () => {
  ...
  const subMenuItems = {
    ...
    "tools-insights": [],
    "account-management": [],
    security: [{ key: "overview", label: "overview" }],
  };
      ...
      if (menuRef.current && indicatorRef.current) {
        ...
        if (activeItem) {
          ...
          if (wrapper) {
            ...
            // 获取菜单项内文字元素的位置（更精确）
            const textElement =
              activeItem.querySelector(".ant-menu-title-content") || activeItem;
            ...
            // 计算相对于wrapper的位置
            const positionRelativeToWrapper =
              textCenterAbsolute - wrapperRect.left;
  ...
  return (
    <div className="app-header-container">
      ...
      {!shouldHideNavMenu &&
        ...
        location.pathname !== "/accounts/detail" && (
          <>
            {location.pathname === "/statements" &&
            location.search.includes("all-wire-activity") ? (
              <div className="statements-tabs-container">
                <div className="statements-tabs">
                  <div
                    className={`statements-tab-item ${
                      statementsTab === "payment-activity" ? "active" : ""
                    }`}
                    onClick={() => setStatementsTab("payment-activity")}
                  >
                    Payment activity
                  </div>
                  <div
            ...
            ) : location.pathname === "/customer-insights" ? (
              <div className="statements-tabs-container">
                <div className="statements-tabs">
                  <div className="statements-tab-item active">
                    Wires & global transfers
                  </div>
                  <div className="statements-tab-item statements-tab-item-with-underline">
                    Send money
                  </div>
                  <div className="statements-tab-item">Payment activity</div>
                  <div className="statements-tab-item">Manage recipients</div>
                  <div className="statements-tab-item">
                    Help & support
                    <DownOutlined
          ...
          <div className="menu-drawer-main">
              ...
              return (
                <div
                  ...
                  className={`menu-drawer-item ${
                    item.hasIcon ? "menu-drawer-item-with-icon" : ""
                  } ${isActive ? "active" : ""}`}
                  onClick={() => handleDrawerMenuClick(item)}
                >
            ...
            {exploreProductsItems.map((item) => {
              ...
              return (
                <div
                  key={item.key}
                  className={`menu-drawer-item menu-drawer-item-with-icon ${
                    isActive ? "active" : ""
                  }`}
                  onClick={() => handleDrawerMenuClick(item)}
                >
